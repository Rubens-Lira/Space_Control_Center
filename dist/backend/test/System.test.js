...
export class SystemTest {
    ...
    testTicketFlow() {
        ...
        const ticket1 = this.controlCenter.receptionistService.processNewRequest(1, // receptionistId
        1, // spaceshipId
        "Falha crítica no sistema de comunicação", true, // humansInvolved
        Priority.EMERGENCY);
        const ticket2 = this.controlCenter.receptionistService.processNewRequest(2, // receptionistId  
        2, // spaceshipId
        "Problema no painel de energia", false, // humansInvolved
        Priority.HIGH);
        const ticket3 = this.controlCenter.receptionistService.processNewRequest(1, // receptionistId
        3, // spaceshipId  
        "Consulta de rotina de dados", false, // humansInvolved
        Priority.NORMAL);
    ...
    testStatistics() {
        ...
        porPrioridade.forEach((quantidade, prioridade) => {
        ...
        porReceptionist.forEach((quantidade, receptionistId) => {
