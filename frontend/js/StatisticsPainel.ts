...
export class StatisticsPanel {
  ...
  private getStatisticsHTML(): string {
    return `
  ...
  private updateGeneralStats(general: any): void {
  ...
  private updateTodayStats(today: any): void {
  ...
  private updateQueueStats(realTime: any): void {
  ...
  private updatePriorityStats(byPriority: Map<Priority, number>): void {
    const priorityStatsElem = document.getElementById('priorityStats');
    if (!priorityStatsElem) return;
  ...
  private updateTopSpaceships(topSpaceships: any[]): void {
    const topSpaceshipsElem = document.getElementById('topSpaceships');
    if (!topSpaceshipsElem) return;
  ...
  private updateTopSpecialists(topSpecialists: any[]): void {
    const topSpecialistsElem = document.getElementById('topSpecialists');
    if (!topSpecialistsElem) return;
  ...
  private updateTopReceptionists(topReceptionists: any[]): void {
    const topReceptionistsElem = document.getElementById('topReceptionists');
    if (!topReceptionistsElem) return;
